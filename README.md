...
````
apt update -y && apt upgrade -y && wget -y; bash <(wget -qO- raw.githubusercontent.com/vmell0/sshpro/main/ssh-plus)
````

# SEGUNDA OPÇÃO PARA INSTALAÇÃO

````
apt update -y && apt upgrade -y && wget https://raw.githubusercontent.com/vmell0/sshpro/main/ssh-plus && chmod 777 ssh-plus && ./ssh-plus
````
