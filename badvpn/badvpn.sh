    ...
    menu
	    ...
	    inst_udp () {
			...
			apt-get install dos2unix -y
                        wget https://raw.githubusercontent.com/vmell0/sshpro/main/badvpn/badvpn-udpgw -o /dev/null
			wget https://raw.githubusercontent.com/vmell0/sshpro/main/badvpn/antcrashvpn.sh -o /dev/null
